...
@section('content')
    ...
    <div x-data="{ cartOpen: false }">
        ...
        <div :class="cartOpen ? 'translate-x-0 ease-out' : 'translate-x-full ease-in'" class="fixed right-0 top-0 max-w-xs w-full h-full px-6 py-4 transition duration-300 transform overflow-y-auto rounded-2xl shadow-2xl bg-white border-primary border-l-2 border-gray-300">
            ...
            <div class="mt-8">
                ...
                <form class="flex items-center justify-center">
                    <a href="{{route('user.dashboard')}}" class="flex items-center justify-center mt-4 px-3 py-2 bg-primary text-white text-sm uppercase font-medium rounded hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="h-64 rounded-md overflow-hidden bg-cover bg-center" style="background-image: url('https://orion-uploads.openroadmedia.com/xl_df60a8f8672d-bestof2019.jpg')">

                <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                    <div class="px-10 max-w-xl">
                        <h2 class="text-2xl text-white font-semibold">Crime Thrillers</h2>
                        <p class="mt-2 text-gray-400">Crime thriller books plunge readers into suspenseful worlds of intrigue, mystery, and danger. With gripping plots and complex characters, they keep you guessing until the very end.</p>
                        <button class="flex items-center mt-4 px-3 py-2 bg-primary text-white text-sm uppercase font-medium rounded hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                            <span>Shop Now</span>
                            <svg class="h-5 w-5 mx-2" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                        </button>
                    </div>
            ...
            <div class="md:flex mt-8 md:-mx-4">
                ...
                <div class="w-full h-64 md:mx-4 rounded-md overflow-hidden bg-cover bg-center md:w-1/2" style="background-image: url('https://cdn.grove.wgbh.org/24/e9/0c8d993d25033b166a6cc3e347f9/books.png')">

                    <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                        <div class="px-10 max-w-xl">
                            <h2 class="text-2xl text-white font-semibold">Fantasy Books</h2>
                            <p class="mt-2 text-gray-400">Fantasy books transport readers to magical realms, where heroes battle dark forces</p>
                ...
                <div class="w-full h-64 mt-8 md:mx-4 rounded-md overflow-hidden bg-cover bg-center md:mt-0 md:w-1/2" style="background-image: url('https://static.toiimg.com/photo/msid-92651823/92651823.jpg')">
                    <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                        <div class="px-10 max-w-xl">
                            <h2 class="text-2xl text-white font-semibold">Drama Books</h2>
                            <p class="mt-2 text-gray-400">Drama books explore human emotions, relationships, and conflicts, delving into the complexities of life.</p>
                            <button class="flex items-center mt-4 text-white text-sm uppercase font-medium rounded hover:underline focus:outline-none">
                                <span>Shop Now</span>
                                <svg class="h-5 w-5 mx-2" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                            </button>
