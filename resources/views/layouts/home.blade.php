        ...
        <div class="relative mt-6 max-w-lg mx-auto">
            ...
            @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'welcome')
                <form action="{{route('welcome')}}" method="GET">
                    <a href="{{route('books.search')}}"> <input class="w-full border rounded-md pl-10 pr-4 py-2 focus:border-blue-500 focus:outline-none focus:shadow-outline" type="text" placeholder="Search"></a>
