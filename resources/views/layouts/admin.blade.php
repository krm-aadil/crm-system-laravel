...
<header>
    <aside class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-blue-200 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        <div>
           ...
           <a  href="/user/profile">
               <div class="mt-8 text-center">
                   <img src="{{asset("img/admin.png")}}" alt="" class="w-10 h-10 m-auto rounded-full object-cover border-2 lg:w-28 lg:h-28">
                   <h5 class="hidden mt-4 text-xl font-semibold text-gray-600 lg:block">Admin</h5>
                   <span class="hidden text-black-400 lg:block">Livre - Your best crm solution </span>
               </div>
           </a>
